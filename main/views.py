...
def homepage(request):
    ...
    myFilter = ArticleSeriesFilter(request.GET, queryset=matching_series)
    matching_series = myFilter.qs
    return render(
        request=request,
...
def series(request, series: str):
    ...
    myFilter = ArticleFilter(request.GET, queryset=matching_series)
    matching_series = myFilter.qs
